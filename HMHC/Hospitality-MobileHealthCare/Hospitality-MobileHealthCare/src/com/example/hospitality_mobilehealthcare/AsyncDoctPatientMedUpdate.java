...
public class AsyncDoctPatientMedUpdate extends AsyncTask<Void, Integer, String>{
	ProgressDialog progressDialog;
	InputStream is;
	
	String url="http://192.168.43.93/MobileHealthCare/DoctorConsultUpdate.php";
	String result1;
	DoctorConsultActivity obj;

	public AsyncDoctPatientMedUpdate(DoctorConsultActivity doctorConsultActivity) {
		// TODO Auto-generated constructor stub
		obj=doctorConsultActivity;
	}
	@Override
	protected String doInBackground(Void... arg0) {
		...
		li.add(new BasicNameValuePair("medicines",obj.smed));
