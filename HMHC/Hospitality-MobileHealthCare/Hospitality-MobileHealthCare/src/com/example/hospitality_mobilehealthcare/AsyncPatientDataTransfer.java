...
public class AsyncPatientDataTransfer extends AsyncTask<Void, Integer, String>{
	ProgressDialog progressDialog;
	InputStream is;
	String url="http://192.168.43.93/MobileHealthCare/UserDataTransfer.php";
	String result1;
	PatientprofileActivity obj;

	public AsyncPatientDataTransfer(PatientprofileActivity patientprofileActivity) {
	...
	protected String doInBackground(Void... params) {
		...
		li.add(new BasicNameValuePair("username",obj.spatient));
