...
public class AsynchronousNurseConsult extends AsyncTask<Void, Integer, String>{
	ProgressDialog progressDialog;
	InputStream is;
	
	String url="http://192.168.43.93/MobileHealthCare/nurseconsult.php";
	String result;
	NurseConsultActivity obj;
	

	public AsynchronousNurseConsult(NurseConsultActivity nurseConsultActivity) {
