...
public class AsynchronousRegistration extends AsyncTask<Void, Integer, String>{
	ProgressDialog progressDialog;
	InputStream is;
	
	String url="http://192.168.43.93/MobileHealthCare/registration.php";
	String result;
	RegisterActivity obj;

	public AsynchronousRegistration(RegisterActivity registerActivity) {
		// TODO Auto-generated constructor stub
		obj=registerActivity;
	}
	@Override
	protected String doInBackground(Void... arg0) {
		...
		li.add(new BasicNameValuePair("role",obj.s));
		li.add(new BasicNameValuePair("token", obj.sid));
		li.add(new BasicNameValuePair("username",obj.suser));
		li.add(new BasicNameValuePair("password",obj.spwd));
