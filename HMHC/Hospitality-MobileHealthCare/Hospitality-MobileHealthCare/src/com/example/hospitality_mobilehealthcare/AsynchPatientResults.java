...
public class AsynchPatientResults extends AsyncTask<Void, Integer, String>{
	ProgressDialog progressDialog;
	InputStream is;
	
	String url="http://192.168.43.93/MobileHealthCare/Results.php";
	String result;
	PatientResultsActivity obj;

	public AsynchPatientResults(PatientResultsActivity patientResultsActivity) {
		// TODO Auto-generated constructor stub
		obj=patientResultsActivity;
	}
	@Override
	protected String doInBackground(Void... arg0) {
		...
		li.add(new BasicNameValuePair("username",obj.s));
		try {
