...
public class AsynchronousNurseUpdate extends AsyncTask<Void, Integer, String>{
	ProgressDialog progressDialog;
	InputStream is;
	
	String url="http://192.168.43.93/MobileHealthCare/update.php";
	String result;
	NurseprofileActivity obj;
	

	public AsynchronousNurseUpdate(NurseprofileActivity nurseprofileActivity) {
	...
	protected String doInBackground(Void... arg0) {
		...
		li.add(new BasicNameValuePair("specialization",obj.sspl));
