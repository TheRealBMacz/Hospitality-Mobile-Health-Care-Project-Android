...
public class Asynchronouslogin extends AsyncTask<Void, Integer, String> {
	ProgressDialog progressDialog;
	InputStream is;
	String url="http://192.168.43.93/MobileHealthCare/login.php";
	String result;
	MainActivity obj;

	
	public Asynchronouslogin(MainActivity mainActivity) {
	...
	protected String doInBackground(Void... arg0) {
		...
		li.add(new BasicNameValuePair("username",obj.sname));
		li.add(new BasicNameValuePair("password", obj.spassword));
