...
public class AsynchNurseDataTransfer extends AsyncTask<Void, Integer, String>{
    
	ProgressDialog progressDialog;
	InputStream is;
	String url="http://192.168.43.93/MobileHealthCare/NurseDataTransfer.php";
	String result1;
	NurseprofileActivity obj;
	public AsynchNurseDataTransfer(NurseprofileActivity nurseprofileActivity) {
		obj=nurseprofileActivity;
	...
	protected String doInBackground(Void... arg0) {
		...
		li.add(new BasicNameValuePair("username",obj.snurse));
