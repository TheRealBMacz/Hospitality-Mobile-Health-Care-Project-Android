...
public class AsynchronousDoctorConsult extends AsyncTask<Void, Integer, String>{
	ProgressDialog progressDialog;
	InputStream is;
	
	String url="http://192.168.43.93/MobileHealthCare/DoctorConsult.php";
	String result;
	DoctorConsultActivity obj;

	public AsynchronousDoctorConsult(DoctorConsultActivity doctorConsultActivity) {
	...
	protected String doInBackground(Void... arg0) {
		...
		li.add(new BasicNameValuePair("username",obj.si));
		try {
